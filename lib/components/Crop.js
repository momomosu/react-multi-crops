  ...
  function Crop() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleResizeMove", function (e) {
      var _this$props2 = _this.props,
        ...
        width = _this$props2$coordina.width,
        height = _this$props2$coordina.height,
      ...
      var dx = e.dx,
        dy = e.dy,
        edges = e.edges;
      var _e$delta = e.delta,
        dex = _e$delta.dex,
        dey = _e$delta.dey;
      var _e$deltaRect = e.deltaRect,
        left = _e$deltaRect.left,
        top = _e$deltaRect.top;
      var addX = edges.left && left !== 0 ? dx : 0;
      var addY = edges.top && top !== 0 ? dy : 0;
      var newX = edges.left ? r - newW : x;
      var newY = edges.top ? b - newH : y;
