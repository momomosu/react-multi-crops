...
var MultiCrops = exports.MultiCrops = function MultiCrops(_ref) {
  ...
  var _useState13 = (0, _react.useState)(0),
    ...
    imageLeft = _useState14[0],
    setImageLeft = _useState14[1];
  var _useState15 = (0, _react.useState)(0),
    _useState16 = _slicedToArray(_useState15, 2),
    imageTop = _useState16[0],
    setImageTop = _useState16[1];
  var onImageLoad = function onImageLoad() {
    ...
    var containerHeight = image.clientHeight;
    var naturalWidth = image.naturalWidth,
      naturalHeight = image.naturalHeight;
    var aspectRatio = naturalWidth / naturalHeight;
    var displayedWidth, displayedHeight, _zoom;
  ...
  var handleMouseDown = function handleMouseDown(e) {
    if (e.target === imgRef.current || e.target === containerRef.current) {
      ...
      setColorIndex(function (i) {
        return i >= colors.length - 1 ? 0 : i + 1;
      });
    }
  };
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    ...
    style: {
      left: imageLeft + ImagePadding + "px",
      top: imageTop + ImagePadding + "px",
      position: "absolute"
    }
