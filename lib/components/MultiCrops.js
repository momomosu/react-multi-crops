  ...
  function MultiCrops() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleMouseMove", function (e) {
      ...
      if (isValidPoint(pointA)) {
        ...
        onDraw === null || onDraw === void 0 || onDraw(coordinate, _this.drawingIndex, nextCoordinates);
        _this.onChangeCrop(coordinate, _this.drawingIndex, nextCoordinates);
      }
    });
    _defineProperty(_assertThisInitialized(_this), "handlMouseUp", function () {
      _this.pointA = {};
    });
    _defineProperty(_assertThisInitialized(_this), "onChangeCrop", function (coordinate, index, _crops) {
      var _this$props$onChange, _this$props3;
      _crops.forEach(function (c) {
        return c.className = "";
      });
      coordinate.className = "active";
      (_this$props$onChange = (_this$props3 = _this.props).onChange) === null || _this$props$onChange === void 0 || _this$props$onChange.call(_this$props3, coordinate, index, _crops);
    });
    _defineProperty(_assertThisInitialized(_this), "onClickCrop", function (coordinate, index) {
      var _this$props$onChange2, _this$props4;
      _this.props.coordinates.forEach(function (c) {
        return c.className = "";
      });
      coordinate.className = "active";
      (_this$props$onChange2 = (_this$props4 = _this.props).onChange) === null || _this$props$onChange2 === void 0 || _this$props$onChange2.call(_this$props4, coordinate, index, _toConsumableArray(_this.props.coordinates));
    });
    return _this;
  }
  _createClass(MultiCrops, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        alt: "",
        draggable: false
      }), this.props.coordinates.map(function (coor, index) {
